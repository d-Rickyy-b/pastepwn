...
class TestBcryptHashAnalyzer(unittest.TestCase):
    ...
    def test_match(self):
        valid_hashes = [
            "$2a$10$BIgnlSmYE8qYiONM0NQ53eRWBw5G4HIJEbXKzcsRVt.08IDnqH/V.",
        ...
        invalid_hashes = [
            "7168D46050573DDA4CE409FA1515638BD28E86346D45F686310ED0678172BABCD4117FD15DD380B964352FE879FB745B573A730D526BB1188B2790FBA06E8ACA",
    ...
    def test_multiple(self):
        ...
        self.paste.body = (
            "We now have a hashe inside the text: $2a$11$EppiRqR0kG9EKy56edDWTOnsv/oGW0dqAJB9ucmn3augbmcm8v/iy and some text here!"
