...
class TestHashAnalyzer(unittest.TestCase):
    def setUp(self):
        self.analyzer = HashAnalyzer(None, [b"hunter2", b"SuperSecurePassword!123", b""])
        self.paste = mock.Mock()

    def test_match(self):
        md5_hashes = ["2ab96390c7dbe3439de74d0c9b0b1767", "0fceb0a9f3d9e4a454df92965c7d9f3e", "d41d8cd98f00b204e9800998ecf8427e"]
        sha1_hashes = ["f3bbbd66a63d4bf1747940578ec3d0103530e21d", "1a0f39c3bdc08e7e3bb6f02ed181ad96ee90f766", "da39a3ee5e6b4b0d3255bfef95601890afd80709"]
        sha256_hashes = [
